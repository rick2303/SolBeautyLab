    ...
    >
      ...
      >
        ...
        <div className="mt-5 text-center font-serif text-xl font-semibold">
          {t("Welcome! Set your own password")}
        </div>
        <p className="mt-1.5 text-center text-[12.5px] leading-relaxed text-muted">
          {t("You signed in with a temporary password — choose a new one to continue")}
        </p>
